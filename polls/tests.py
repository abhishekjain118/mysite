...
class QuestionModelTest(TestCase):
    def test_was_published_recently_with_future_question(self):
        #was_published_recently() returns false for question of future date
...
class QuestionIndexViewTest(TestCase):
    def test_no_question(self):
        ...
        self.assertQuerysetEqual(response.context['key_latest_question_list'], [])
    ...
    def test_past_question(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['key_latest_question_list'],['<Question: past_question.>'])
